    ...
    public partial class Form1 : Form
    {
        ...
        public class LinkedList
        {
            ...
            private Node Find(Object item)
            {
                ...
                while (current.Link != null &&
                    !object.Equals(current.Element, item))
                {
                    current = current.Link;
                }
                return current;
            ...
            private Node FindPrevious(Object item)
            {
                ...
                while (current.Link != null &&
                    !object.Equals(current.Link.Element, item))
                {
                    current = current.Link;
                }
                return current;
            ...
            public string PrintList()
            {
                ...
                while (!(current.Link == null))
                {
                    s += String.Format("{0} -> ", current.Link.Element);
                    current = current.Link;
                }
                return s + " null\n";
            }
        ...
        {
            ll.InsertAfter(textValue.Text, textAfter.Text);
            richTextBox1.Text += ll.PrintList();
            textValue.Text = "";
            textAfter.Text = "";
        }
